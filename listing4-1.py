...
GAME_MAP += [
        ...
        ["Security portal to mission control", 7, 7, True, True],
...
def generate_map():
    ...
    global top_left_x, top_left_y, wall_trancparency_frame
    ...
    if current_room % MAP_WIDTH != 1:
        ...
        if room_to_left[4]:
            room_map[0][middle_row][0] = floor_type
            room_map[0][middle_row + 1][0] = floor_type
            room_map[0][middle_row - 1][0] = floor_type
